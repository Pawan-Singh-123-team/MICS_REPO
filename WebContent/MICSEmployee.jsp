...
<s:form action="employeeCreate.action" method="post" namespace="/" validate="true">
...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="address" key="mics.form.address" size="50" class="fontContent"/></td>
		<td>&nbsp;</td>
	</tr>
	 -->
	<tr>
		...
		<td class="textField">:</td>
		<td><s:select name="usertype" list="userTypes" listKey="id" listValue="name" label="Select Type" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"><s:submit action="employeeAddNumber" key="mics.form.add" align="left" /></td>
		<td>&nbsp;</td>
	</tr>
	...
	<tr>
		...
		<td colspan="3">
			...
			<s:iterator value="micsUserNumberReq" status="stat" var="numberReq" >
				<tr>
					...
					<td>
						...
						<s:if test='%{#numberReq.publicNumber == #currMainPublic}'>
							<s:checkbox name="micsUserNumberReq[%{#stat.index}].mainPublic" fieldValue="true" value="true" onClick="toggle(this,'N','mainPublic');" label="Set as Main"/>
					...
					<td>
						<s:textfield name="micsUserNumberReq[%{#stat.index}].privateNumber" key="mics.form.privateNumber" size="5" class="fontContent" readonly="true"/>
						<s:if test='%{#numberReq.privateNumber == #currMainPrivate}'>
							<s:checkbox name="micsUserNumberReq[%{#stat.index}].mainPrivate" fieldValue="true" value="true" onClick="toggle(this,'Y','mainPrivate');" label="Set as Main"/>
							<s:text name="mics.form.setAsMain"/>
						</s:if>
						<s:else>
    			...
    			<tr>
    				<td colspan="5"><s:submit action="employeeDelNumber" key="mics.form.delete" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>
	...
	<tr>
		...
		<td>
			...
			<s:select name="groupkey" list="groups" listKey="groupid" listValue="%{groupid + ' - ' + groupname}" label="Select Group Id" width="264" style="width: 264px" />
		</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		<th colspan="5" align="center">MICS Employee Security</th>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="textField"><s:text name="mics.form.pin"/></td>
		<td class="textField">:</td>
		<td><s:password name="pin" key="mics.form.pin" size="35" class="fontContent"/> <s:text name="mics.form.pin5digit"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="outcsdesc" key="mics.form.callScreeningDesc" size="25" class="fontContent"/></td>
		<td>&nbsp;</td>
	</tr>
	-->
	<tr>
	...
	<tr>
		...
		<td class="textField"><s:text name="mics.form.callScreeningDesc"/></td>
		<td class="textField">:</td>
		<td><s:textfield name="incsdesc" key="mics.form.callScreeningDesc" size="25" class="fontContent"/></td>
		<td>&nbsp;</td>
	</tr>
	-->
	<tr>

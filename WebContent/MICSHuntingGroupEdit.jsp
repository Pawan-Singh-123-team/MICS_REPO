...
<!-- $Id: MICSHuntingGroupEdit.jsp,v 1.1.4.3 2019/03/22 10:05:30 cvsuser Exp $ -->
<s:form action="huntingGroupEdit.action" method="post" namespace="/">
...
<table class="formOutlineOrange">
	...
	<tr>
		<th colspan="5" align="center">Hunting Group Edit</th>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3"><s:submit action="huntingGroupEditAddTimeband" key="mics.form.add" align="left" onclick="clickAddButton()"/></td>
		<td>&nbsp;</td>
	</tr>
	<!--  Iterate Timeband -->
		...
		<td colspan="3">
			...
			<s:iterator value="huntingscheduleReg" status="stat" var="hsReq" >
				<tr>
					...
					<td>
						<s:submit action="huntingGroupViewScheduleEdit" key="mics.form.editScheduleMember" onclick="clickEditButton('%{#stat.index}')" align="center" />          
					</td>
				</tr>
    		</s:iterator>
    			<tr>
    				<td colspan="5"><s:submit action="huntingGroupEditDelTimeband" key="mics.form.delete" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>

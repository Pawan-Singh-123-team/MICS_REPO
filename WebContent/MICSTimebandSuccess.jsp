...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<!--<s:textfield name="effectiveStartTime" key="mics.form.effStartTime" size="35" class="fontContent"/> yyyy/MM/dd HH:mm</td>-->
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<!--<s:textfield name="effectiveStopTime" key="mics.form.effStopTime" size="35" class="fontContent"/> yyyy/MM/dd HH:mm</td>-->
		<td>&nbsp;</td>
	</tr>
</table>

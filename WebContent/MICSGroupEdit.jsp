...
<td>&nbsp;</td>
<td  valign="top">
<s:form action="groupEdit.action" method="post" namespace="/" validate="true">
...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField"><s:text name="mics.form.callScreeningName"/></td>
		<td class="textField">:</td>
		<td><s:select name="incs" list='incomingProfiles' headerKey="" headerValue="Select Incoming Profile" listKey="callscreeningkey" listValue="%{callscreeningname + ' - ' + callscreeningdesc}" label="Select Profile" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr>

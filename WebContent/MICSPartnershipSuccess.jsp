...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:select name="companykey1" list='companyList' listKey="companykey" listValue="companyname" label="Select Company" disabled="true" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:select name="companykey2" list='companyList' listKey="companykey" listValue="companyname" label="Select Company" disabled="true" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr> 
</table>

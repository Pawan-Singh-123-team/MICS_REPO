...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="companyWebUserName" key="mics.form.username" size="35" class="fontContent" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:password name="companyWebUserPassword" key="mics.form.password" size="35" class="fontContent" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:password name="companyWebUserPasswordConf" key="mics.form.confPassword" size="35" class="fontContent" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="textField"><s:text name="mics.form.callScreeningName"/></td>
		<td class="textField">:</td>
		<td><s:select name="defaultincs" headerKey="" headerValue="Select Incoming Profile" list='incomingProfiles' listValue="%{callscreeningname + ' - ' + callscreeningdesc}" label="Select Profile" width="264" style="width: 264px" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>

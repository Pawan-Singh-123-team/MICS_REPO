...
<td>&nbsp;</td>
<td  valign="top">
<s:form action="userDelSubmit.action" method="post" namespace="/">
...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:select name="roleList" list="role" listKey="rolekey" listValue="rolename" label="Select Role" width="264" style="width: 264px" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:select name="companyList" list="company" headerKey="1" headerValue="Select Company" listKey="companykey" listValue="companyname" label="Select Company" width="264" style="width: 264px" disabled="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" class="textWarn">Are you really want to delete this User ? this process can not be undone</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>

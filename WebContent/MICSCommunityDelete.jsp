...
<s:form action="communityDelete.action" method="post" namespace="/" validate="true">
...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td><s:textfield name="communityname" key="mics.form.communityName" size="35" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" class="textWarn">Are you really want to delete this community ? this process can not be undone</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>

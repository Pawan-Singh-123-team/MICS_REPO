...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="companyname" key="mics.form.companyName" size="35" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<s:if test="tselAdmin">
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="chargestring" key="mics.form.chargeString" size="35" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	</s:if>
	<s:else>
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="contactperson" key="mics.form.contactPerson" size="35" class="fontContent" readonly="true" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:textfield name="email" key="mics.form.email" size="35" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:textfield name="address" key="mics.form.address" size="35" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" class="textWarn">Are you really want to delete this company ? this process can not be undone</td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>

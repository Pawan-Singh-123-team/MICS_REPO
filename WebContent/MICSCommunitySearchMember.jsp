...
<s:form action="communitySearchMember.action" method="post" namespace="/">
...
<tr>
	...
	<table class="formOutlineOrange">
		...
		<tr>
			<td>&nbsp;</td>
			<td colspan="3" class="textField"><s:submit method="communitySearchMember" key="mics.form.search" align="center" /></td>
			<td>&nbsp;</td>
		</tr>
		<tr>
			<td colspan="5">&nbsp;</td>
		...
		<tr>
			...
			<s:iterator value="searchMemberRes" status="stat" var="iterMemberRes" >
    			...
    			<tr>
    				<td colspan="6"><s:submit action="communityAddMember" key="mics.form.add" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>
    	</td>

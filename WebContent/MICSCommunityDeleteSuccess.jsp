...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td><s:textfield name="communityname" key="mics.form.communityName" size="30" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td class="textField">:</td>
		<td><s:textfield name="contactperson" key="mics.form.contactPerson" size="30" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:textfield name="address" key="mics.form.address" size="50" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		...
		<td class="textField">:</td>
		<td><s:textfield name="email" key="mics.form.email" size="30" class="fontContent" readonly="true"/></td>
		<td>&nbsp;</td>
	</tr>

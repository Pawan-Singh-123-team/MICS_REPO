...
<s:form action="huntingGroupScheduleSearchMember.action" method="post" namespace="/">
...
<tr>
	...
	<table class="formOutlineOrange">
		<tr>
			<th colspan="5" align="center">MICS Hunting Group Search Member</th>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<s:iterator value="searchMemberRes" status="stat" var="iterMemberRes" >
    			...
    			<tr>
    				<td colspan="6"><s:submit action="huntingGroupScheduleAddMember" key="mics.form.add" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>
    	</td>

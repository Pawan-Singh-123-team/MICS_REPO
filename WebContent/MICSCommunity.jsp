...
<s:form action="communityCreate.action" method="post" namespace="/" validate="true">
...
<table class="formOutlineOrange">
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" class="textField"><s:submit action="communityInitSearchMember" key="mics.form.add" align="left" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
		...
		<td colspan="3">
			...
			<s:iterator value="memberReq" status="stat" var="iterMemberReq" >
    			...
    			<tr>
    				<td colspan="5"><s:submit action="communityDelMember" key="mics.form.delete" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>

...
<table class="formOutlineOrange">
	...
	<tr>
		...
		<td><s:textfield name="callscreeningname" key="mics.form.callScreeningName" size="35" class="fontContent"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	...
	<tr>
	 ...
	 <tr>
		...
		<td class="textField">:</td>
		<td><s:hidden name="screeningtype"/><s:select name="screeningtype" list='screeningtypes' listKey="id" listValue="name" label="Select Type" onchange="onTypeChange()" disabled="true" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
	 ...
	 <s:else>
		...
		<td class="textField"><s:text name="mics.form.type"/>*</td>
		<td class="textField">:</td>
		<td><s:select name="screeningtype" list='screeningtypes' listKey="id" listValue="name" label="Select Type" onchange="onTypeChange()" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td class="textField"><s:text name="mics.form.level"/>*</td>
		<td class="textField">:</td>
		<td><s:select name="screeninglevel" list='screeninglevels' listKey="id" listValue="name" label="Select Level" width="264" style="width: 264px"/></td>
		<td>&nbsp;</td>
	</tr> 
	 </s:else>
	...
	<tr>
		<td>&nbsp;</td>
		<td colspan="3" class="textField"><s:submit action="profileInitRuleAdd" key="mics.form.addRule" align="center" onclick="clickAddButton()" /></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		...
		<td colspan="3">
			...
			<s:iterator value="rules" status="stat" var="screeningRule" >
				<tr>
					...
					<td>
						<s:submit action="profileInitRuleEdit" key="mics.form.editRule" onclick="clickEditButton('%{#stat.index}')" align="center" />
					</td>
				</tr>
    		</s:iterator>
    			<tr>
    				<td colspan="5"><s:submit action="profileRuleDelete" key="mics.form.delRule" align="center" /></td>
    			</tr>
    		</tbody>
    		</table>

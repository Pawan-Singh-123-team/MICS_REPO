 ...
 * @see com.nsn.telkomsel.mics.orahbm.Incomingcallscreening
	...
	public Incomingcallscreening findById(java.lang.String id) {
		...
		try {
			Incomingcallscreening instance = (Incomingcallscreening) sessionFactory
					.getCurrentSession()
					.get("com.nsn.telkomsel.mics.orahbm.Incomingcallscreening",
							id);
			if (instance == null) {
	...
	public List findByExample(Incomingcallscreening instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.nsn.telkomsel.mics.orahbm.Incomingcallscreening")

 ...
 * @see com.nsn.telkomsel.mics.orahbm.Loggedoffhuntingmember
...
public class LoggedoffhuntingmemberHome {
	...
	public Loggedoffhuntingmember findById(
			com.nsn.telkomsel.mics.orahbm.LoggedoffhuntingmemberId id) {
		...
		try {
			Loggedoffhuntingmember instance = (Loggedoffhuntingmember) sessionFactory
					.getCurrentSession()
					.get("com.nsn.telkomsel.mics.orahbm.Loggedoffhuntingmember",
							id);
			if (instance == null) {
	...
	public List findByExample(Loggedoffhuntingmember instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.nsn.telkomsel.mics.orahbm.Loggedoffhuntingmember")

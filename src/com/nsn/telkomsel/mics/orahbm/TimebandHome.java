 ...
 * @see com.nsn.telkomsel.mics.orahbm.Timeband
...
public class TimebandHome {
	...
	public Timeband findById(com.nsn.telkomsel.mics.orahbm.TimebandId id) {
		log.debug("getting Timeband instance with id: " + id);
		try {
			Timeband instance = (Timeband) sessionFactory.getCurrentSession()
					.get("com.nsn.telkomsel.mics.orahbm.Timeband", id);
			if (instance == null) {
	...
	public List findByExample(Timeband instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.nsn.telkomsel.mics.orahbm.Timeband")

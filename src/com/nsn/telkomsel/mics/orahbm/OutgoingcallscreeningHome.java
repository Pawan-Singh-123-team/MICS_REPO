 ...
 * @see com.nsn.telkomsel.mics.orahbm.Outgoingcallscreening
	...
	public Outgoingcallscreening findById(java.lang.String id) {
		...
		try {
			Outgoingcallscreening instance = (Outgoingcallscreening) sessionFactory
					.getCurrentSession()
					.get("com.nsn.telkomsel.mics.orahbm.Outgoingcallscreening",
							id);
			if (instance == null) {
	...
	public List findByExample(Outgoingcallscreening instance) {
		...
		try {
			List results = sessionFactory
					.getCurrentSession()
					.createCriteria(
							"com.nsn.telkomsel.mics.orahbm.Outgoingcallscreening")
